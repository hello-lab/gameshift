    ...
    <html lang="en">
      ...
      >
        ...
        <nav className="fixed bottom-0 left-0 right-0 flex gap-2 border-t-4 border-verse-purple bg-verse-dark px-4 pb-6 pt-3 z-30 shadow-2xl">
          <a className="flex flex-1 flex-col items-center justify-center gap-1 text-verse-light/50 group hover:text-white transition-colors" href="/battleship">
            ...
            <p className="text-[10px] font-pixel mt-1">BattleShip</p>
          </a>
